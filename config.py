...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5658733188:AAGgaODwm-gnUHcTSBz68w4p2xkDzNLQip8")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001157009177"))
...
USER_REPLY_TEXT = "❌Don't send me messages directly I'm only File Share bot!u want like this bot dm @Beastonejnanesh"
